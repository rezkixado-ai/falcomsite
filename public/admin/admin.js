(() => {
  ...
  const SCHEMAS = {
    ...
    chat_regions: {
      label: 'Sales Wilayah (Live Chat)', endpoint: 'chat_regions', listEl: '#chatRegionsList',
      title: r => r.region_name, sub: r => r.wa_number,
      fields: [
        { name: 'region_name', label: 'Nama Wilayah (cth: Jawa & Bali)', type: 'text', required: true },
        { name: 'wa_number', label: 'Nomor WA (format 62xxxxxxxxxx, tanpa +/spasi)', type: 'text', required: true },
  ...
  const panelLoaders = {
    ...
    chat_regions: () => loadList('chat_regions'),
